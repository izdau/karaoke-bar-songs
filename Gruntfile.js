// Generated on 2015-02-23 using generator-angular-cordova 0.0.1
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        shell: {
            iossimstart: {
                command: 'ios-sim launch platforms/ios/build/karaokeBarSongs.app --exit' + (device.family !== 'default' ? ' --family ' + device.family : ''),
                options: {
                    stdout: true
                }
            },
